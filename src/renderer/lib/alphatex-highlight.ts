...
export function createAlphaTexHighlightForTheme(theme: EditorTheme): Extension[] {
...
export async function getAlphaTexHighlight(theme?: EditorTheme): Promise<Extension[]> {
	if (theme) {
